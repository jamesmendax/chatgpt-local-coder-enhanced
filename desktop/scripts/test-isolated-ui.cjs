...
(async () => {
  ...
  await waitFor(win, "state.accountId && state.accountId !== 'default' && document.getElementById('dashboard-account-name').textContent === '第二账号验收'", "second account created and selected");
